...
// pub fn serialize<T: serde::Serialize>(key: &T) -> CResult<Vec<u8>> {
...
// pub fn deserialize<'a, T: serde::Deserialize<'a>>(input: &'a [u8]) -> CResult<T> {
...
//     }
//
//     fn serialize_i8(self, value: i8) -> CResult<()> {
//         unimplemented!()
//     }
//
//     fn serialize_i16(self, value: i16) -> CResult<()> {
//         unimplemented!()
//     }
//
//     fn serialize_i32(self, value: i32) -> CResult<()> {
//         unimplemented!()
//     }
//
...
//     }
//
//     fn serialize_i128(self, value: i128) -> CResult<()> {
//         unimplemented!()
//     }
//
//     fn serialize_u8(self, value: u8) -> CResult<()> {
//         unimplemented!()
//     }
//
//     fn serialize_u16(self, value: u16) -> CResult<()> {
//         unimplemented!()
//     }
//
//     fn serialize_u32(self, value: u32) -> CResult<()> {
//         unimplemented!()
//     }
//
...
//     }
//
//     fn serialize_f32(self, _: f32) -> CResult<()> {
//         unimplemented!()
//     }
//
...
//     }
//
//     fn serialize_char(self, c: char) -> CResult<()> {
//         unimplemented!()
//     }
//
...
//     }
//
//     fn serialize_some<T: serde::Serialize + ?Sized>(self, _: &T) -> CResult<()> {
//         unimplemented!()
//     }
//
...
//     }
//
//     fn serialize_unit_struct(self, _: &'static str) -> CResult<()> {
//         self.serialize_unit()
//     }
//
...
//     fn serialize_seq(self, _: Option<usize>) -> CResult<Self::SerializeSeq> {
//         Ok(self)
//     }
//
//     // Tuples are serialized as the concatenation of the serialized elements.
//     fn serialize_tuple(self, _: usize) -> CResult<Self::SerializeTuple> {
//         Ok(self)
//     }
//
...
//     }
//
//     fn serialize_map(self, _: Option<usize>) -> CResult<Self::SerializeMap> {
//         unimplemented!()
//     }
//
//     fn serialize_struct(self, name: &'static str, len: usize,) -> CResult<Self::SerializeStruct> {
//         unimplemented!()
//     }
//
...
//     type Error = Error;
//
//     fn serialize_element<T: serde::Serialize + ?Sized>(&mut self, value: &T) -> CResult<()> {
...
//     type Error = Error;
//
//     fn serialize_field<T: serde::Serialize + ?Sized>(&mut self, value: &T) -> CResult<()> {
//         value.serialize(&mut **self)
//     }
//
//     fn end(self) -> CResult<()> {
...
//     fn take_bytes(&mut self, len: usize) -> CResult<&[u8]> {
...
//     fn decode_next_bytes(&mut self) -> CResult<Vec<u8>> {
...
//     type Error = Error;
//
//     fn deserialize_any<V: de::Visitor<'de>>(self, _: V) -> CResult<V::Value> {
...
//     }
//
//     fn deserialize_i8<V: de::Visitor<'de>>(self, _: V) -> CResult<V::Value> {
//         unimplemented!()
//     }
//
//     fn deserialize_i16<V: de::Visitor<'de>>(self, _: V) -> CResult<V::Value> {
//         unimplemented!()
//     }
//
//     fn deserialize_i32<V: de::Visitor<'de>>(self, _: V) -> CResult<V::Value> {
//         unimplemented!()
//     }
//
...
//     }
//
//     fn deserialize_u8<V: de::Visitor<'de>>(self, _: V) -> CResult<V::Value> {
//         unimplemented!()
//     }
//
//     fn deserialize_u16<V: de::Visitor<'de>>(self, _: V) -> CResult<V::Value> {
//         unimplemented!()
//     }
//
//     fn deserialize_u32<V: de::Visitor<'de>>(self, _: V) -> CResult<V::Value> {
//         unimplemented!()
//     }
//
...
//     }
//
//     fn deserialize_f32<V: de::Visitor<'de>>(self, _: V) -> CResult<V::Value> {
//         unimplemented!()
//     }
//
...
//     }
//
//     fn deserialize_char<V: de::Visitor<'de>>(self, _: V) -> CResult<V::Value> {
//         unimplemented!()
//     }
//
...
//     }
//
//     fn deserialize_option<V: de::Visitor<'de>>(self, _: V) -> CResult<V::Value> {
//         unimplemented!()
//     }
//
//     fn deserialize_unit<V: de::Visitor<'de>>(self, _: V) -> CResult<V::Value> {
//         unimplemented!()
//     }
//
...
//     }
//
//     fn deserialize_tuple<V: de::Visitor<'de>>(self, _: usize, visitor: V) -> CResult<V::Value> {
//         visitor.visit_seq(self)
//     }
//
...
//     }
//
//     fn deserialize_map<V: de::Visitor<'de>>(self, _: V) -> CResult<V::Value> {
//         unimplemented!()
//     }
//
...
//     }
//
//     fn deserialize_identifier<V: de::Visitor<'de>>(self, _: V) -> CResult<V::Value> {
//         unimplemented!()
//     }
//
//     fn deserialize_ignored_any<V: de::Visitor<'de>>(self, _: V) -> CResult<V::Value> {
//         unimplemented!()
//     }
// }
//
...
//         self,
//         seed: V,
//     ) -> CResult<(V::Value, Self::Variant)> {
//         let index = self.take_bytes(1)?[0] as u32;
//         let value: CResult<_> = seed.deserialize(index.into_deserializer());
//         Ok((value?, self))
//     }
// }
//
...
//     }
//
//     fn tuple_variant<V: de::Visitor<'de>>(self, _: usize, visitor: V) -> CResult<V::Value> {
//         visitor.visit_seq(self)
//     }
//
